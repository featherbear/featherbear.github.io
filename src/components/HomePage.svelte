<script lang="ts">
  ...
  let imageSet = (function () {
    /*
      Effect bits:
      0b--X background blur
      0b-X- foreground blur
      0bX-- foreground unrotate (the foreground image rotated 180 deg usually)
    */
    const backgroundImages = {
      "bg/bg01-min.jpg": 0b011,
      "bg/bg02-min.jpg": 0b110,
      'bg/bg08-min.jpg': 0b010,
      "bg/bg19-min.jpg": 0b010,
      'bg/2022/IMG_4060_exp.jpg': 0b101,
    }
    
    let profileImages = [
      "bg/bg17-min.jpg",
      "bg/2022/0T4A9920.jpg",
      "bg/2022/0T4A9896.jpg",
      "bg/2022/20220413-0t4a9037_exp.jpg",
      "2025/20250225_120243.jpg",
      "2025/20250119_152345(0).jpg",
      "2025/20250329_160839.jpg",
      "2025/20250615_102559.jpg"
    ];

    const profileOverrides: Record<string, string | string[]> = {
      "bg/bg02-min.jpg": ["2025/20250615_102559.jpg", "bg/2022/20220413-0t4a9037_exp.jpg"],
      "bg/bg09-min.jpg": ["2025/20250615_102559.jpg", "bg/2022/20220413-0t4a9037_exp.jpg"],
      'bg/2022/IMG_4060_exp.jpg': ["bg/2022/0T4A9920.jpg", "bg/2022/0T4A9896.jpg"]
    };
    ...
    if (profileOverrides[background]) {
      const overrides = profileOverrides[background]
      profileImages = Array.isArray(overrides) ? overrides : [overrides];
    }
  ...
  function setBackgroundImage(elem: HTMLDivElement) {
    elem.style.backgroundImage = `url(/assets/images/${imageSet.background})`;
  ...
  function setProfileImage(elem: HTMLDivElement) {
    elem.style.backgroundImage = `url(/assets/images/${imageSet.foreground})`;
  }
</script>
